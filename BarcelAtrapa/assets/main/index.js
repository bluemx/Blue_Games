...
System.register("chunks:///_virtual/main", ['./debug-view-runtime-control.ts', './CambioEscena.ts', './Collision.ts', './InputManager.ts', './Items.ts', './Manager_Pausa.ts', './MovimientoCubeta.ts', './ObjetoBueno.ts', './SomeOtherScript.ts', './Timer.ts', './intrucciones.ts'], function () {
  return {
...
System.register("chunks:///_virtual/Manager_Pausa.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      ...
      var ccclass = _decorator.ccclass,
          property = _decorator.property;
      var Manager_Pausa = exports('Manager_Pausa', (_dec = ccclass('Manager_Pausa'), _dec2 = property(Boolean), _dec3 = property(Boolean), _dec4 = property(Node), _dec5 = property(Node), _dec(_class = (_class2 = /*#__PURE__*/function (_Component) {
