    ...
    execute: function () {
      ...
      _export("BallSpawner", BallSpawner = (_dec = ccclass('BallSpawner'), _dec2 = property(Prefab), _dec3 = property(Node), _dec4 = property({
        ...
        updateSpawnSpeed() {
          ...
          var speedReduction = this.speedIncreaseRate * this.gameTime;
        ...
        spawnBall() {
          ...
          var canvasTransform = this.canvas.getComponent(UITransform);
          ...
          if (isGoldenBall) {
            ...
            var sprite = ball.getComponent(Sprite);
...
//# sourceMappingURL=41c671a7d0caa8c21f7496c88da826a9121300de.js.map