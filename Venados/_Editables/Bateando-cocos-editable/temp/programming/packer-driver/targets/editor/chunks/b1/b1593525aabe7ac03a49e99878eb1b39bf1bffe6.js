    ...
    execute: function () {
      ...
      _export("BateosCtrl", BateosCtrl = (_dec = ccclass('BateosCtrl'), _dec2 = property(Label), _dec3 = property(_crd && SceneRouter === void 0 ? (_reportPossibleCrUseOfSceneRouter({
        ...
        async triggerGameOver() {
          ...
          console.log(`Final Score: ${this.currentScore}`); // Store the final score globally so it persists across scenes

          globalThis.finalScore = this.currentScore;
          console.log(`💾 Stored final score globally: ${this.currentScore}`); // Also emit the event (in case the scene is already loaded)
...
//# sourceMappingURL=b1593525aabe7ac03a49e99878eb1b39bf1bffe6.js.map