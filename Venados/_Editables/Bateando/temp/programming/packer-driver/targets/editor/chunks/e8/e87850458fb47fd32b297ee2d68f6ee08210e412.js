    ...
    execute: function () {
      ...
      _export("GameManager", GameManager = (_dec = ccclass('GameManager'), _dec2 = property(_crd && BallController === void 0 ? (_reportPossibleCrUseOfBallController({
        ...
        start() {
          ...
          const all = [this.catcherZone, this.batSwing, ...this.boundsSensors];
          all.forEach((n, index) => {
            if (!n) {
        ...
        onBegin(self, other, _contact) {
          ...
          const isBallVs = tag => a === Tag.BALL && b === tag || b === Tag.BALL && a === tag;
...
//# sourceMappingURL=e87850458fb47fd32b297ee2d68f6ee08210e412.js.map