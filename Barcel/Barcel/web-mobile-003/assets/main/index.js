...
System.register("chunks:///_virtual/Loader.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      ...
      cclegacy._RF.push({}, "6a6feXhbONK45PMC+lNLIFt", "Loader", undefined);
      ...
      var Loader = exports('Loader', (_dec = ccclass('Loader'), _dec2 = property(cc.SpriteAtlas), _dec(_class = (_class2 = /*#__PURE__*/function (_Component) {
        ...
        _proto.start = function start() {
          var self = this;
          var remoteurl = 'https://firebasestorage.googleapis.com/v0/b/bluegamesmx.appspot.com/o/texturaPrueba%2Ftexture.png?alt=media&token=fcf897b7-f5a1-4e13-803b-74e67f227205'; // Descarga de imagen
